...
## Tips
- You can use loops with recursion. While functional programming avoids loops, recursion is also used outside functional programming.
- The built-in [isinstance function](https://docs.python.org/3/library/functions.html#isinstance) can tell you if an item is an integer or a list:
```python
isinstance(5, list)
# False
isinstance([5, 6], list)
